...
def load_data(dataset):
    ...
    :type dataset: string
    :param dataset: the path to the dataset (here GAZE)
    '''
...
def sgd_optimization_gaze(learning_rate=0.13, n_epochs=1000,
                          dataset='/home/vishwa/work/dbn/train_utils/data/gaze_data.pkl.gz',
                          batch_size=400):
    """
    Demonstrate stochastic gradient descent optimization of a log-linear
    model

    This is demonstrated on GAZE data.
    ...
    :type dataset: string
    :param dataset: the path of the GAZE dataset file
    ...
    # Each GAZE image has size 100*100
    classifier = LogisticRegression(input=x, n_in=100 * 100, n_out=5)
